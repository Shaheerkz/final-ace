            ...
            <div className="col-12">
              <div className="row">
                <div className="services-content-wrp position-relative">
                  <div className="row">
                    <div className="col-xxl-4 col-12" data-aos="fade-right">
                      <div className="">
                        <div className="wrp">
                    ...
                    <div
                      className="col-xxl-8 col-12 mb-5 wrp"
                      data-aos="fade-left"
                    >
                  ...
                  <div className="row mt-5 wrp  line-wrp">
                  ...
                  <div className="row mt-5 wrp">
                    <div className="col-12 position-relative before-line">
                      <div
